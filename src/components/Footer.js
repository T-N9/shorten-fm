...
const Footer = () => {
    return (
        <footer className=' mx-auto bg-neutral-vDarkViolet text-white py-12'>
            <div className='max-w-[1108px] lg:w-[100%] mx-auto lg:flex justify-between'>
                <div className='mb-10'>
                    <svg className='mx-auto' xmlns="http://www.w3.org/2000/svg" width="121" height="33">
                        <path
                            fill="white"
                ...
                <div className='lg:flex'>
                    <div className='lg:flex'>
                        <div className='text-center lg:text-left lg:mr-20 mb-10'>
                            <h1 className='text-white font-bold text-base mb-5'>
                                Features
                            </h1>
                    ...
                    <div className='flex mx-auto lg:mx-0 justify-between w-[50%] lg:w-[170px]'>
                        <a href="">
